...
from comtypes import CLSCTX_ALL #control volumes of laptop
...
while True:
    ...
    if status:
        ...
        if result is not None:
            ...
            cv2.circle(image,(x1,y1),15,(255,0,255),cv2.FILLED) #circle---> the pixel on image (red one)
            cv2.circle(image,(x2,y2),15,(255,0,255),cv2.FILLED)
            cv2.line(image,(x1,y1),(x2,y2),(255,0,255),3) #create line join 2 points
